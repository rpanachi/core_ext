...
class BasicCallbacksTest < CoreExt::TestCase
  def setup
...
class InheritedCallbacksTest < CoreExt::TestCase
  def setup
...
class InheritedCallbacksTest2 < CoreExt::TestCase
  def setup
...
class DynamicInheritedCallbacks < CoreExt::TestCase
