...
class MultibyteProxyText < CoreExt::TestCase
  ...
  def with_custom_encoder(encoder)
    original_proxy_class = CoreExt::Multibyte.proxy_class

    begin
      CoreExt::Multibyte.proxy_class = encoder

      yield
    ensure
      CoreExt::Multibyte.proxy_class = original_proxy_class
    end
  end
