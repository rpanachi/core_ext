...
class MessageVerifierTest < CoreExt::TestCase
  ...
  def setup
    @verifier = CoreExt::MessageVerifier.new("Hey, I'm a secret!")
  ...
  def test_alternative_serialization_method
    ...
    verifier = CoreExt::MessageVerifier.new("Hey, I'm a secret!", :serializer => JSONSerializer.new)
  ...
  def test_raise_error_when_secret_is_nil
    exception = assert_raise(ArgumentError) do
      CoreExt::MessageVerifier.new(nil)
    end
