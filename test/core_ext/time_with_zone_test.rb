...
class TimeWithZoneTest < CoreExt::TestCase
  include TimeZoneTestHelpers

  def setup
    @utc = Time.utc(2000, 1, 1, 0)
    @time_zone = CoreExt::TimeZone['Eastern Time (US & Canada)']
    @twz = CoreExt::TimeWithZone.new(@utc, @time_zone)
  end
  ...
  def test_in_time_zone
    Time.use_zone 'Alaska' do
      assert_equal CoreExt::TimeWithZone.new(@utc, CoreExt::TimeZone['Alaska']), @twz.in_time_zone
    end
  end

  def test_in_time_zone_with_argument
    assert_equal CoreExt::TimeWithZone.new(@utc, CoreExt::TimeZone['Alaska']), @twz.in_time_zone('Alaska')
  end

  def test_in_time_zone_with_new_zone_equal_to_old_zone_does_not_create_new_object
    assert_equal @twz.object_id, @twz.in_time_zone(CoreExt::TimeZone['Eastern Time (US & Canada)']).object_id
  end
  ...
  def test_utc?
    ...
    assert_equal true, CoreExt::TimeWithZone.new(Time.utc(2000), CoreExt::TimeZone['UTC']).utc?
    assert_equal true, CoreExt::TimeWithZone.new(Time.utc(2000), CoreExt::TimeZone['Etc/UTC']).utc?
    assert_equal true, CoreExt::TimeWithZone.new(Time.utc(2000), CoreExt::TimeZone['Universal']).utc?
    assert_equal true, CoreExt::TimeWithZone.new(Time.utc(2000), CoreExt::TimeZone['UCT']).utc?
    assert_equal true, CoreExt::TimeWithZone.new(Time.utc(2000), CoreExt::TimeZone['Etc/UCT']).utc?
    assert_equal true, CoreExt::TimeWithZone.new(Time.utc(2000), CoreExt::TimeZone['Etc/Universal']).utc?

    assert_equal false, CoreExt::TimeWithZone.new(Time.utc(2000), CoreExt::TimeZone['Africa/Abidjan']).utc?
    assert_equal false, CoreExt::TimeWithZone.new(Time.utc(2000), CoreExt::TimeZone['Africa/Banjul']).utc?
    assert_equal false, CoreExt::TimeWithZone.new(Time.utc(2000), CoreExt::TimeZone['Africa/Freetown']).utc?
    assert_equal false, CoreExt::TimeWithZone.new(Time.utc(2000), CoreExt::TimeZone['GMT']).utc?
    assert_equal false, CoreExt::TimeWithZone.new(Time.utc(2000), CoreExt::TimeZone['GMT0']).utc?
    assert_equal false, CoreExt::TimeWithZone.new(Time.utc(2000), CoreExt::TimeZone['Greenwich']).utc?
    assert_equal false, CoreExt::TimeWithZone.new(Time.utc(2000), CoreExt::TimeZone['Iceland']).utc?
    assert_equal false, CoreExt::TimeWithZone.new(Time.utc(2000), CoreExt::TimeZone['Africa/Monrovia']).utc?
  end

  def test_formatted_offset
    assert_equal '-05:00', @twz.formatted_offset
    assert_equal '-04:00', CoreExt::TimeWithZone.new(Time.utc(2000, 6), @time_zone).formatted_offset #dst
  end

  def test_dst?
    assert_equal false, @twz.dst?
    assert_equal true, CoreExt::TimeWithZone.new(Time.utc(2000, 6), @time_zone).dst?
  end

  def test_zone
    assert_equal 'EST', @twz.zone
    assert_equal 'EDT', CoreExt::TimeWithZone.new(Time.utc(2000, 6), @time_zone).zone #dst
  end

  def test_nsec
    local     = Time.local(2011,6,7,23,59,59,Rational(999999999, 1000))
    with_zone = CoreExt::TimeWithZone.new(nil, CoreExt::TimeZone["Hawaii"], local)
  ...
  def test_to_yaml
    yaml = <<-EOF.strip_heredoc
      --- !ruby/object:CoreExt::TimeWithZone
      utc: 2000-01-01 00:00:00.000000000 Z
      zone: !ruby/object:CoreExt::TimeZone
  ...
  def test_ruby_to_yaml
    yaml = <<-EOF.strip_heredoc
      ---
      twz: !ruby/object:CoreExt::TimeWithZone
        utc: 2000-01-01 00:00:00.000000000 Z
        zone: !ruby/object:CoreExt::TimeZone
          name: America/New_York
        time: 1999-12-31 19:00:00.000000000 Z
  ...
  def test_compare_with_time_with_zone
    assert_equal  1, @twz <=> CoreExt::TimeWithZone.new( Time.utc(1999, 12, 31, 23, 59, 59), CoreExt::TimeZone['UTC'] )
    assert_equal  0, @twz <=> CoreExt::TimeWithZone.new( Time.utc(2000, 1, 1, 0, 0, 0), CoreExt::TimeZone['UTC'] )
    assert_equal(-1, @twz <=> CoreExt::TimeWithZone.new( Time.utc(2000, 1, 1, 0, 0, 1), CoreExt::TimeZone['UTC'] ))
  end
  ...
  def test_today
    Date.stub(:current, Date.new(2000, 1, 1)) do
      assert_equal false, CoreExt::TimeWithZone.new( nil, @time_zone, Time.utc(1999,12,31,23,59,59) ).today?
      assert_equal true, CoreExt::TimeWithZone.new( nil, @time_zone, Time.utc(2000,1,1,0) ).today?
      assert_equal true, CoreExt::TimeWithZone.new( nil, @time_zone, Time.utc(2000,1,1,23,59,59) ).today?
      assert_equal false, CoreExt::TimeWithZone.new( nil, @time_zone, Time.utc(2000,1,2,0) ).today?
    end
  end
  ...
  def test_past_with_time_current_as_time_local
    with_env_tz 'US/Eastern' do
      Time.stub(:current, Time.local(2005,2,10,15,30,45)) do
        assert_equal true, CoreExt::TimeWithZone.new( nil, @time_zone, Time.local(2005,2,10,15,30,44)).past?
        assert_equal false, CoreExt::TimeWithZone.new( nil, @time_zone, Time.local(2005,2,10,15,30,45)).past?
        assert_equal false, CoreExt::TimeWithZone.new( nil, @time_zone, Time.local(2005,2,10,15,30,46)).past?
      end
    end
  end

  def test_past_with_time_current_as_time_with_zone
    twz = CoreExt::TimeWithZone.new( nil, @time_zone, Time.local(2005,2,10,15,30,45) )
  ...
  def test_future_with_time_current_as_time_local
    with_env_tz 'US/Eastern' do
      Time.stub(:current, Time.local(2005,2,10,15,30,45)) do
        assert_equal false, CoreExt::TimeWithZone.new( nil, @time_zone, Time.local(2005,2,10,15,30,44)).future?
        assert_equal false, CoreExt::TimeWithZone.new( nil, @time_zone, Time.local(2005,2,10,15,30,45)).future?
        assert_equal true, CoreExt::TimeWithZone.new( nil, @time_zone, Time.local(2005,2,10,15,30,46)).future?
      end
    end
  end
  ...
  def test_eql?
    ...
    assert_equal true, @twz.eql?( CoreExt::TimeWithZone.new(Time.utc(2000), CoreExt::TimeZone["Hawaii"]) )
    assert_equal false, @twz.eql?( Time.utc(2000, 1, 1, 0, 0, 1) )
    assert_equal false, @twz.eql?( DateTime.civil(1999, 12, 31, 23, 59, 59) )

    other_twz = CoreExt::TimeWithZone.new(DateTime.now.utc, @time_zone)
    assert_equal true, other_twz.eql?(other_twz.dup)
  end

  def test_hash
    assert_equal Time.utc(2000).hash, @twz.hash
    assert_equal Time.utc(2000).hash, CoreExt::TimeWithZone.new(Time.utc(2000), CoreExt::TimeZone["Hawaii"]).hash
  end
  ...
  def test_plus_with_integer_when_self_wraps_datetime
    ...
    twz = CoreExt::TimeWithZone.new(datetime, @time_zone)
    assert_equal DateTime.civil(1999, 12, 31, 19, 0 ,5), (twz + 5).time
  end

  def test_plus_when_crossing_time_class_limit
    twz = CoreExt::TimeWithZone.new(Time.utc(2038, 1, 19), @time_zone)
  ...
  def test_minus_with_time
    assert_equal  86_400.0,  CoreExt::TimeWithZone.new( Time.utc(2000, 1, 2), CoreExt::TimeZone['UTC'] ) - Time.utc(2000, 1, 1)
    assert_equal  86_400.0,  CoreExt::TimeWithZone.new( Time.utc(2000, 1, 2), CoreExt::TimeZone['Hawaii'] ) - Time.utc(2000, 1, 1)
  end

  def test_minus_with_time_precision
    assert_equal  86_399.999999998,  CoreExt::TimeWithZone.new( Time.utc(2000, 1, 2, 23, 59, 59, Rational(999999999, 1000)), CoreExt::TimeZone['UTC'] ) - Time.utc(2000, 1, 2, 0, 0, 0, Rational(1, 1000))
    assert_equal  86_399.999999998,  CoreExt::TimeWithZone.new( Time.utc(2000, 1, 2, 23, 59, 59, Rational(999999999, 1000)), CoreExt::TimeZone['Hawaii'] ) - Time.utc(2000, 1, 2, 0, 0, 0, Rational(1, 1000))
  end

  def test_minus_with_time_with_zone
    twz1 = CoreExt::TimeWithZone.new( Time.utc(2000, 1, 1), CoreExt::TimeZone['UTC'] )
    twz2 = CoreExt::TimeWithZone.new( Time.utc(2000, 1, 2), CoreExt::TimeZone['UTC'] )
    assert_equal  86_400.0,  twz2 - twz1
  end

  def test_minus_with_time_with_zone_precision
    twz1 = CoreExt::TimeWithZone.new( Time.utc(2000, 1, 1, 0, 0, 0, Rational(1, 1000)), CoreExt::TimeZone['UTC'] )
    twz2 = CoreExt::TimeWithZone.new( Time.utc(2000, 1, 1, 23, 59, 59, Rational(999999999, 1000)), CoreExt::TimeZone['UTC'] )
    assert_equal  86_399.999999998,  twz2 - twz1
  end

  def test_minus_with_datetime
    assert_equal  86_400.0,  CoreExt::TimeWithZone.new( Time.utc(2000, 1, 2), CoreExt::TimeZone['UTC'] ) - DateTime.civil(2000, 1, 1)
  end

  def test_minus_with_datetime_precision
    assert_equal  86_399.999999999,  CoreExt::TimeWithZone.new( Time.utc(2000, 1, 1, 23, 59, 59, Rational(999999999, 1000)), CoreExt::TimeZone['UTC'] ) - DateTime.civil(2000, 1, 1)
  end

  def test_minus_with_wrapped_datetime
    assert_equal  86_400.0,  CoreExt::TimeWithZone.new( DateTime.civil(2000, 1, 2), CoreExt::TimeZone['UTC'] ) - Time.utc(2000, 1, 1)
    assert_equal  86_400.0,  CoreExt::TimeWithZone.new( DateTime.civil(2000, 1, 2), CoreExt::TimeZone['UTC'] ) - DateTime.civil(2000, 1, 1)
  end
  ...
  def test_to_a
    assert_equal [45, 30, 5, 1, 2, 2000, 2, 32, false, "HST"], CoreExt::TimeWithZone.new( Time.utc(2000, 2, 1, 15, 30, 45), CoreExt::TimeZone['Hawaii'] ).to_a
  end

  def test_to_f
    result = CoreExt::TimeWithZone.new( Time.utc(2000, 1, 1), CoreExt::TimeZone['Hawaii'] ).to_f
    assert_equal 946684800.0, result
    assert_kind_of Float, result
  end

  def test_to_i
    result = CoreExt::TimeWithZone.new( Time.utc(2000, 1, 1), CoreExt::TimeZone['Hawaii'] ).to_i
  ...
  def test_to_r
    result = CoreExt::TimeWithZone.new(Time.utc(2000, 1, 1), CoreExt::TimeZone['Hawaii']).to_r
    assert_equal Rational(946684800, 1), result
    assert_kind_of Rational, result
  end

  def test_time_at
    time = CoreExt::TimeWithZone.new(Time.utc(2000, 1, 1), CoreExt::TimeZone['Hawaii'])
  ...
  def test_to_date
    ...
    assert_equal Date.new(1999, 12, 31), CoreExt::TimeWithZone.new( Time.utc(2000, 1, 1, 4, 59, 59), CoreExt::TimeZone['Eastern Time (US & Canada)'] ).to_date
    # midnight Jan 1 EST
    assert_equal Date.new(2000,  1,  1), CoreExt::TimeWithZone.new( Time.utc(2000, 1, 1, 5,  0,  0), CoreExt::TimeZone['Eastern Time (US & Canada)'] ).to_date
    # 1 sec before midnight Jan 2 EST
    assert_equal Date.new(2000,  1,  1), CoreExt::TimeWithZone.new( Time.utc(2000, 1, 2, 4, 59, 59), CoreExt::TimeZone['Eastern Time (US & Canada)'] ).to_date
    # midnight Jan 2 EST
    assert_equal Date.new(2000,  1,  2), CoreExt::TimeWithZone.new( Time.utc(2000, 1, 2, 5,  0,  0), CoreExt::TimeZone['Eastern Time (US & Canada)'] ).to_date
  end
  ...
  def test_acts_like_time
    ...
    assert CoreExt::TimeWithZone.new(DateTime.civil(2000), @time_zone).acts_like?(:time)
  end

  def test_acts_like_date
    assert_equal false, @twz.acts_like?(:date)
    assert_equal false, CoreExt::TimeWithZone.new(DateTime.civil(2000), @time_zone).acts_like?(:date)
  end

  def test_is_a
    assert_kind_of Time, @twz
    assert_kind_of Time, @twz
    assert_kind_of CoreExt::TimeWithZone, @twz
  end

  def test_class_name
    assert_equal 'Time', CoreExt::TimeWithZone.name
  end

  def test_method_missing_with_time_return_value
    assert_instance_of CoreExt::TimeWithZone, @twz.months_since(1)
  ...
  def test_marshal_dump_and_load
    ...
    assert_equal CoreExt::TimeZone['Eastern Time (US & Canada)'], mtime.time_zone
  ...
  def test_marshal_dump_and_load_with_tzinfo_identifier
    twz = CoreExt::TimeWithZone.new(@utc, TZInfo::Timezone.get('America/New_York'))
    marshal_str = Marshal.dump(twz)
    mtime = Marshal.load(marshal_str)
    assert_equal Time.utc(2000, 1, 1, 0), mtime.utc
    assert mtime.utc.utc?
  ...
  def test_date_part_value_methods
    twz = CoreExt::TimeWithZone.new(Time.utc(1999,12,31,19,18,17,500), @time_zone)
  ...
  def test_usec_returns_0_when_datetime_is_wrapped
    twz = CoreExt::TimeWithZone.new(DateTime.civil(2000), @time_zone)
    assert_equal 0, twz.usec
  end

  def test_usec_returns_sec_fraction_when_datetime_is_wrapped
    twz = CoreExt::TimeWithZone.new(DateTime.civil(2000, 1, 1, 0, 0, Rational(1,2)), @time_zone)
  ...
  def test_instance_created_with_local_time_returns_correct_utc_time
    twz = CoreExt::TimeWithZone.new(nil, @time_zone, Time.utc(1999, 12, 31, 19))
    assert_equal Time.utc(2000), twz.utc
  end

  def test_instance_created_with_local_time_enforces_spring_dst_rules
    twz = CoreExt::TimeWithZone.new(nil, @time_zone, Time.utc(2006,4,2,2)) # first second of DST
  ...
  def test_instance_created_with_local_time_enforces_fall_dst_rules
    twz = CoreExt::TimeWithZone.new(nil, @time_zone, Time.utc(2006,10,29,1)) # 1AM can be either DST or non-DST; we'll pick DST
  ...
  def test_utc_to_local_conversion_with_far_future_datetime
    assert_equal [0,0,19,31,12,2049], CoreExt::TimeWithZone.new(DateTime.civil(2050), @time_zone).to_a[0,6]
  end

  def test_local_to_utc_conversion_with_far_future_datetime
    assert_equal DateTime.civil(2050).to_f, CoreExt::TimeWithZone.new(nil, @time_zone, DateTime.civil(2049,12,31,19)).to_f
  end
  ...
  def test_change_at_dst_boundary
    twz = CoreExt::TimeWithZone.new(Time.at(1319936400).getutc, CoreExt::TimeZone['Madrid'])
  ...
  def test_advance_1_year_from_leap_day
    twz = CoreExt::TimeWithZone.new(nil, @time_zone, Time.utc(2004,2,29))
  ...
  def test_advance_1_month_from_last_day_of_january
    twz = CoreExt::TimeWithZone.new(nil, @time_zone, Time.utc(2005,1,31))
  ...
  def test_advance_1_month_from_last_day_of_january_during_leap_year
    twz = CoreExt::TimeWithZone.new(nil, @time_zone, Time.utc(2000,1,31))
  ...
  def test_advance_1_month_into_spring_dst_gap
    twz = CoreExt::TimeWithZone.new(nil, @time_zone, Time.utc(2006,3,2,2))
  ...
  def test_advance_1_second_into_spring_dst_gap
    twz = CoreExt::TimeWithZone.new(nil, @time_zone, Time.utc(2006,4,2,1,59,59))
  ...
  def test_advance_1_day_across_spring_dst_transition
    twz = CoreExt::TimeWithZone.new(nil, @time_zone, Time.utc(2006,4,1,10,30))
  ...
  def test_advance_1_day_across_spring_dst_transition_backwards
    twz = CoreExt::TimeWithZone.new(nil, @time_zone, Time.utc(2006,4,2,10,30))
    # In 2006, spring DST transition occurred Apr 2 at 2AM; this day was only 23 hours long
  ...
  def test_advance_1_day_expressed_as_number_of_seconds_minutes_or_hours_across_spring_dst_transition_backwards
    twz = CoreExt::TimeWithZone.new(nil, @time_zone, Time.utc(2006,4,2,11,30))
    # In 2006, spring DST transition occurred Apr 2 at 2AM; this day was only 23 hours long
    # When we advance a specific number of hours, minutes or seconds, we want to advance exactly that amount
  ...
  def test_advance_1_day_across_fall_dst_transition
    twz = CoreExt::TimeWithZone.new(nil, @time_zone, Time.utc(2006,10,28,10,30))
  ...
  def test_advance_1_day_across_fall_dst_transition_backwards
    twz = CoreExt::TimeWithZone.new(nil, @time_zone, Time.utc(2006,10,29,10,30))
    # In 2006, fall DST transition occurred Oct 29 at 2AM; this day was 25 hours long
  ...
  def test_advance_1_day_expressed_as_number_of_seconds_minutes_or_hours_across_fall_dst_transition_backwards
    twz = CoreExt::TimeWithZone.new(nil, @time_zone, Time.utc(2006,10,29,9,30))
    # In 2006, fall DST transition occurred Oct 29 at 2AM; this day was 25 hours long
    # When we advance a specific number of hours, minutes or seconds, we want to advance exactly that amount
  ...
  def test_advance_1_month_across_spring_dst_transition_backwards
    twz = CoreExt::TimeWithZone.new(nil, @time_zone, Time.utc(2006,5,1,10,30))
  ...
  def test_advance_1_month_across_fall_dst_transition_backwards
    twz = CoreExt::TimeWithZone.new(nil, @time_zone, Time.utc(2006,11,28,10,30))
  ...
  def test_advance_1_year
    twz = CoreExt::TimeWithZone.new(nil, @time_zone, Time.utc(2008,2,15,10,30))
  ...
  def test_advance_1_year_during_dst
    twz = CoreExt::TimeWithZone.new(nil, @time_zone, Time.utc(2008,7,15,10,30))
...
class TimeWithZoneMethodsForTimeAndDateTimeTest < CoreExt::TestCase
  include TimeZoneTestHelpers
  ...
  def test_localtime
    Time.zone = CoreExt::TimeZone['Eastern Time (US & Canada)']
  ...
  def test_use_zone
    Time.zone = 'Alaska'
    Time.use_zone 'Hawaii' do
      assert_equal CoreExt::TimeZone['Hawaii'], Time.zone
    end
    assert_equal CoreExt::TimeZone['Alaska'], Time.zone
  end
  ...
  def test_time_zone_getter_and_setter
    Time.zone = CoreExt::TimeZone['Alaska']
    assert_equal CoreExt::TimeZone['Alaska'], Time.zone
    Time.zone = 'Alaska'
    assert_equal CoreExt::TimeZone['Alaska'], Time.zone
    Time.zone = -9.hours
  ...
  def test_time_zone_getter_and_setter_with_zone_default_set
    ...
    Time.zone_default = CoreExt::TimeZone['Alaska']
    assert_equal CoreExt::TimeZone['Alaska'], Time.zone
    Time.zone = CoreExt::TimeZone['Hawaii']
    assert_equal CoreExt::TimeZone['Hawaii'], Time.zone
    Time.zone = nil
    assert_equal CoreExt::TimeZone['Alaska'], Time.zone
  ensure
  ...
  def test_time_zone_setter_is_thread_safe
    Time.use_zone 'Paris' do
      ...
      assert_equal CoreExt::TimeZone['Paris'], Time.zone
      assert_equal CoreExt::TimeZone['Alaska'], t1[:time_zone]
      assert_equal CoreExt::TimeZone['Hawaii'], t2[:time_zone]
    end
  end
  ...
  def test_time_zone_setter_with_tzinfo_timezone_object_wraps_in_rails_time_zone
    ...
    Time.zone = tzinfo
    assert_kind_of CoreExt::TimeZone, Time.zone
  ...
  def test_current_returns_time_now_when_zone_not_set
    with_env_tz 'US/Eastern' do
      Time.stub(:now, Time.local(2000)) do
        assert_equal false, Time.current.is_a?(CoreExt::TimeWithZone)
  ...
  def test_current_returns_time_zone_now_when_zone_set
    ...
    with_env_tz 'US/Eastern' do
      Time.stub(:now, Time.local(2000)) do
        assert_equal true, Time.current.is_a?(CoreExt::TimeWithZone)
...
class TimeWithZoneMethodsForDate < CoreExt::TestCase
  include TimeZoneTestHelpers
...
class TimeWithZoneMethodsForString < CoreExt::TestCase
  include TimeZoneTestHelpers
