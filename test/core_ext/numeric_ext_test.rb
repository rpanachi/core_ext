...
class NumericExtTimeAndDateTimeTest < CoreExt::TestCase
  def setup
...
class NumericExtDateTest < CoreExt::TestCase
  def setup
    @today = Date.today
  end
...
class NumericExtSizeTest < CoreExt::TestCase
...
class NumericExtFormattingTest < CoreExt::TestCase
  ...
  def test_to_s__human_size
    ...
    assert_equal '1 PB',      terabytes(1026).to_s(:human_size)
