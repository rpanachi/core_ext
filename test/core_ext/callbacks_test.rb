...
module CallbacksTest
  ...
  class OneTimeCompileTest < CoreExt::TestCase
  ...
  class AfterSaveConditionalPersonCallbackTest < CoreExt::TestCase
  ...
  class AroundCallbacksTest < CoreExt::TestCase
  ...
  class AroundCallbackResultTest < CoreExt::TestCase
    def test_save_around
  ...
  class SkipCallbacksTest < CoreExt::TestCase
  ...
  class CallbacksTest < CoreExt::TestCase
  ...
  class ConditionalCallbackTest < CoreExt::TestCase
  ...
  class ResetCallbackTest < CoreExt::TestCase
    def test_save_conditional_person
  ...
  class UsingObjectTest < CoreExt::TestCase
  ...
  class CallbackTerminatorTest < CoreExt::TestCase
  ...
  class CallbackTerminatorSkippingAfterCallbacksTest < CoreExt::TestCase
  ...
  class CallbackDefaultTerminatorTest < CoreExt::TestCase
  ...
  class CallbackFalseTerminatorWithoutConfigTest < CoreExt::TestCase
  ...
  class CallbackFalseTerminatorWithConfigTrueTest < CoreExt::TestCase
    def setup
      CoreExt::Callbacks.halt_and_display_warning_on_return_false = true
    end
  ...
  class CallbackFalseTerminatorWithConfigFalseTest < CoreExt::TestCase
    def setup
      CoreExt::Callbacks.halt_and_display_warning_on_return_false = false
    end
  ...
  class HyphenatedKeyTest < CoreExt::TestCase
    def test_save
  ...
  class WriterCallbacksTest < CoreExt::TestCase
  ...
  class ExtendCallbacksTest < CoreExt::TestCase
    def test_save
  ...
  class ExcludingDuplicatesCallbackTest < CoreExt::TestCase
  ...
  class CallbackProcTest < CoreExt::TestCase
  ...
  class ConditionalTests < CoreExt::TestCase
    def build_class(callback)
      Class.new {
        include CoreExt::Callbacks
        define_callbacks :foo
  ...
  class CallbackTypeTest < CoreExt::TestCase
