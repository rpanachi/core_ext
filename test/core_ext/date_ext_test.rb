...
class DateExtCalculationsTest < CoreExt::TestCase
  ...
  def test_yesterday_constructor_when_zone_is_set
    with_env_tz 'UTC' do
      with_tz_default CoreExt::TimeZone['Eastern Time (US & Canada)'] do # UTC -5
  ...
  def test_tomorrow_constructor_when_zone_is_set
    with_env_tz 'UTC' do
      with_tz_default CoreExt::TimeZone['Europe/Paris'] do # UTC +1
...
class DateExtBehaviorTest < CoreExt::TestCase
