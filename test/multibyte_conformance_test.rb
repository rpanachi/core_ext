...
class MultibyteConformanceTest < CoreExt::TestCase
  include MultibyteTestHelpers

  UNIDATA_URL = "http://www.unicode.org/Public/#{CoreExt::Multibyte::Unicode::UNICODE_VERSION}/ucd"
