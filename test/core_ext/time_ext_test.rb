...
class TimeExtCalculationsTest < CoreExt::TestCase
  ...
  def test_compare_with_time_with_zone
    assert_equal  1, Time.utc(2000) <=> CoreExt::TimeWithZone.new( Time.utc(1999, 12, 31, 23, 59, 59), CoreExt::TimeZone['UTC'] )
    assert_equal  0, Time.utc(2000) <=> CoreExt::TimeWithZone.new( Time.utc(2000, 1, 1, 0, 0, 0), CoreExt::TimeZone['UTC'] )
    assert_equal(-1, Time.utc(2000) <=> CoreExt::TimeWithZone.new( Time.utc(2000, 1, 1, 0, 0, 1), CoreExt::TimeZone['UTC'] ))
  end
  ...
  def test_at_with_time_with_zone
    assert_equal Time.utc(2000, 1, 1, 0, 0, 0), Time.at(CoreExt::TimeWithZone.new(Time.utc(2000, 1, 1, 0, 0, 0), CoreExt::TimeZone['UTC']))

    # Only test this if the underlying Time.at raises a TypeError
    begin
      Time.at_without_coercion(Time.now, 0)
    rescue TypeError
      assert_raise(TypeError) { assert_equal(Time.utc(2000, 1, 1, 0, 0, 0), Time.at(CoreExt::TimeWithZone.new(Time.utc(2000, 1, 1, 0, 0, 0), CoreExt::TimeZone['UTC']), 0)) }
    end
  end

  def test_at_with_time_with_zone_returns_local_time
    with_env_tz 'US/Eastern' do
      twz = CoreExt::TimeWithZone.new(Time.utc(2000, 1, 1, 0, 0, 0), CoreExt::TimeZone['London'])
      ...
      # Daylight savings
      twz = CoreExt::TimeWithZone.new(Time.utc(2000, 7, 1, 0, 0, 0), CoreExt::TimeZone['London'])
  ...
  def test_eql?
    assert_equal true, Time.utc(2000).eql?( CoreExt::TimeWithZone.new(Time.utc(2000), CoreExt::TimeZone['UTC']) )
    assert_equal true, Time.utc(2000).eql?( CoreExt::TimeWithZone.new(Time.utc(2000), CoreExt::TimeZone["Hawaii"]) )
    assert_equal false,Time.utc(2000, 1, 1, 0, 0, 1).eql?( CoreExt::TimeWithZone.new(Time.utc(2000), CoreExt::TimeZone['UTC']) )
  end

  def test_minus_with_time_with_zone
    assert_equal  86_400.0, Time.utc(2000, 1, 2) - CoreExt::TimeWithZone.new( Time.utc(2000, 1, 1), CoreExt::TimeZone['UTC'] )
  end
  ...
  def test_case_equality
    ...
    assert Time === CoreExt::TimeWithZone.new(Time.utc(2000), CoreExt::TimeZone['UTC'])
    ...
    assert_equal false, Class.new(Time) === CoreExt::TimeWithZone.new(Time.utc(2000), CoreExt::TimeZone['UTC'])
  end
  ...
  def test_all_day_with_timezone
    beginning_of_day = CoreExt::TimeWithZone.new(nil, CoreExt::TimeZone["Hawaii"], Time.local(2011,6,7,0,0,0))
    end_of_day = CoreExt::TimeWithZone.new(nil, CoreExt::TimeZone["Hawaii"], Time.local(2011,6,7,23,59,59,Rational(999999999, 1000)))

    assert_equal beginning_of_day, CoreExt::TimeWithZone.new(Time.local(2011,6,7,10,10,10), CoreExt::TimeZone["Hawaii"]).all_day.begin
    assert_equal end_of_day, CoreExt::TimeWithZone.new(Time.local(2011,6,7,10,10,10), CoreExt::TimeZone["Hawaii"]).all_day.end
  end
...
class TimeExtMarshalingTest < CoreExt::TestCase
