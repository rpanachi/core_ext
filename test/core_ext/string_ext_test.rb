...
class StringAccessTest < CoreExt::TestCase
...
class StringConversionsTest < CoreExt::TestCase
  include TimeZoneTestHelpers
...
class StringBehaviourTest < CoreExt::TestCase
  def test_acts_like_string
    assert 'Bambi'.acts_like_string?
  end
end

class CoreExtStringMultibyteTest < CoreExt::TestCase
  UTF8_STRING = 'こにちわ'
  ...
  def test_mb_chars_returns_instance_of_proxy_class
    assert_kind_of CoreExt::Multibyte.proxy_class, UTF8_STRING.mb_chars
  end
end

class OutputSafetyTest < CoreExt::TestCase
  def setup
    @string = "hello"
...
class StringExcludeTest < CoreExt::TestCase
...
class StringIndentTest < CoreExt::TestCase
