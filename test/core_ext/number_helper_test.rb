...
module CoreExt
  module NumberHelper
    class NumberHelperTest < CoreExt::TestCase

      class TestClassWithInstanceNumberHelpers
        include CoreExt::NumberHelper
      end

      class TestClassWithClassNumberHelpers
        extend CoreExt::NumberHelper
      end
      ...
      def test_number_to_phone
        [@instance_with_helpers, TestClassWithClassNumberHelpers, CoreExt::NumberHelper].each do |number_helper|
