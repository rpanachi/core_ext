...
class BacktraceCleanerFilterTest < CoreExt::TestCase
  def setup
    @bc = CoreExt::BacktraceCleaner.new
...
class BacktraceCleanerSilencerTest < CoreExt::TestCase
  def setup
    @bc = CoreExt::BacktraceCleaner.new
...
class BacktraceCleanerMultipleSilencersTest < CoreExt::TestCase
  def setup
    @bc = CoreExt::BacktraceCleaner.new
    @bc.add_silencer { |line| line =~ /mongrel/ }
...
class BacktraceCleanerFilterAndSilencerTest < CoreExt::TestCase
  def setup
    @bc = CoreExt::BacktraceCleaner.new
